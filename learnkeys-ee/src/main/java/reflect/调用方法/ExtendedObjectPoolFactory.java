...
public class ExtendedObjectPoolFactory {
  ...
  private void initProperty()
    ...
    for (String name : config.stringPropertyNames()) {
      ...
      if (name.contains("%")) {
        ...
        // 该属性对应的setter方法名:set + "首字母大写" + 剩下部分
        String methodName =
            "set" + objAndProp[1].substring(0, 1).toUpperCase() + objAndProp[1].substring(1);
  ...
  public static void main(String[] args) throws Exception {
    ...
    epf.init("D:/idea_Project/YJ/SpraceXBootDemo/web-start/src/main/resources/extObj.txt");
    epf.initPool();
    epf.initProperty();
